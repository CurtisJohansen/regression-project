...
def get_zillow_data():
    ...
    sql_query = '''
                ...
                calculatedfinishedsquarefeet AS calculated_finished_sqft,
                poolcnt AS has_pool,
                ...
                WHERE p.`propertylandusetypeid` IN (260, 261, 262, 263, 264, 265, 268, 273, 274, 275, 276, 279) 
...
def wrangle_zillow():
    ...
    df_outliers = remove_outlier(df[['calculated_finished_sqft', 'bedrooms', 'bathrooms']])
